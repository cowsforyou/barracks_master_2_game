...
function GameMode:OnEntityKilled( keys )
  ...
  if killedUnit.coreSpawn then
    local hero = PlayerResource:GetSelectedHeroEntity(killedUnit:GetPlayerOwnerID())
    if hero then
      local unit_index = getIndexTable(hero.units, killedUnit)
      if unit_index then
