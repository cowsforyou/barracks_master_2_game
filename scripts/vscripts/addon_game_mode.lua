...
PrecacheUnitByNameSync("xoya_building_catlix", context)
PrecacheUnitByNameSync("xoya_building_zavartu", context)
...
PrecacheUnitByNameSync("xoya_creep_zavartu", context)
