ling_purification = class({})

--------------------------------------------------------------------------------
-- AOE Radius
function ling_purification:GetAOERadius()
	return self:GetSpecialValueFor( "radius" )
end

--------------------------------------------------------------------------------
-- Ability Start
function ling_purification:OnSpellStart()
	-- unit identifier
...
function ling_purification:AbilityConsiderations()
	-- Scepter
...
--------------------------------------------------------------------------------
function ling_purification:PlayEffects1( target, radius )
	-- Get Resources
...
function ling_purification:PlayEffects2( origin, target )
